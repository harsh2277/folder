          ...
          {stepsList.map((s) => {
            ...
            return (
              ...
              >
                ...
                <span className={`absolute top-10 text-sm uppercase tracking-wider font-semibold whitespace-nowrap transition-colors duration-300 ${
                      ...
                      >
                        ...
                        <div className="space-y-4">
                          <div className="flex justify-between items-start">
                            ...
                            {p.discount && (
                              <span className="px-2 py-0.5 rounded text-sm font-semibold border bg-amber-50 border-amber-100 text-amber-700">
                                {p.discount}
                              </span>
                            )}
                          </div>
                  ...
                  <div className="space-y-2 bg-white/[0.02] p-3.5 rounded-md border border-white/5 text-sm space-y-2.5">
                    ...
                    {projectDetails.timeline && (
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold text-white">{projectDetails.timeline}</span>
                      </div>
                    )}
                  </div>
                )}
          ...
          <div className="bg-white border border-neutral-200 rounded-md max-w-md w-full p-6 shadow-2xl space-y-6">
            ...
            <div className="flex flex-col space-y-2">
              <button
                ...
                disabled={submitting}
                className="w-full py-2.5 bg-amber-500 hover:bg-amber-600 text-neutral-950 font-semibold text-sm rounded-md transition-colors shadow-sm flex items-center justify-center space-x-1.5"
              >
                <i className="bx bx-check-circle text-sm"></i>
              ...
              <button
                ...
                disabled={submitting}
                className="w-full py-2.5 bg-white border border-neutral-200 hover:bg-neutral-50 text-neutral-700 font-semibold text-sm rounded-md transition-colors flex items-center justify-center space-x-1.5"
              >
              ...
              <button
                ...
                disabled={submitting}
                className="w-full py-2 text-sm font-semibold text-neutral-400 hover:text-neutral-600 transition-colors text-center"
              >
                Cancel & Review
              </button>
            </div>
