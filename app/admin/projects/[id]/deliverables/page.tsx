...
export default function AdminProjectDeliverables() {
  ...
  return (
    <div className="space-y-8">
      {/* Navigation */}
      <div>
        <Link href={`/admin/projects/${project.id}`} className="inline-flex items-center space-x-1 text-sm font-medium text-neutral-500 hover:text-neutral-900 transition-colors">
          ...
          <form onSubmit={handleUpload} className="space-y-5">
            <div>
              ...
              <CustomSelect
                ...
                options={[
                  { value: 'deliverable_report', label: 'Lighting Report' },
                  { value: 'deliverable_boq', label: 'BOQ (Bill of Quantities)' },
                  { value: 'deliverable_lux', label: 'Lux Calculations' },
                  { value: 'deliverable_layout', label: 'Layout Drawing / PDF' }
                ]}
                className="w-full"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-neutral-50 border border-neutral-200 rounded-md text-sm text-neutral-800 file:mr-4 file:py-1 file:px-3 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-neutral-900 file:text-white hover:file:bg-neutral-800 transition-colors"
              />
            ...
            <button
              ...
              className="w-full py-2.5 bg-amber-500 hover:bg-amber-600 text-white font-medium text-sm rounded-md transition-colors duration-200 disabled:opacity-50"
            >
              ...
              {deliverables.map((del) => (
                <div key={del.id} className="py-4 flex justify-between items-center text-sm">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-neutral-800">{del.file_name}</p>
