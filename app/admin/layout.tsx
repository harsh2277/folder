...
const navItems = [
  ...
  { name: 'Payments', path: '/admin/payments', icon: 'bx bx-credit-card', group: 'Configuration' },
  { name: 'Notifications', path: '/admin/notifications', icon: 'bx bx-bell', group: 'System' },
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-neutral-950">
        <div className="flex flex-col items-center space-y-4">
          ...
          <span className="text-neutral-400 text-sm font-semibold tracking-wider">Verifying Session...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="h-screen flex bg-neutral-950 text-neutral-800 overflow-hidden">
      ...
      <aside className={`bg-neutral-950 flex flex-col justify-between text-neutral-300 transition-all duration-300 ${isCollapsed ? 'w-16' : 'w-64'}`}>
        <div className="overflow-y-auto flex-1">
          ...
          <div className={`p-4 flex items-center bg-neutral-950 ${isCollapsed ? 'justify-center' : 'space-x-3'}`}>
            <div className="w-8 h-8 rounded-md bg-amber-500 flex items-center justify-center text-neutral-950 flex-shrink-0">
            ...
            {!isCollapsed && (
              <div>
                ...
                <span className="text-xs text-neutral-500 font-bold">Admin Workspace</span>
              </div>
            )}
          </div>
        ...
        <div className="p-4 bg-neutral-900/10 border-t border-neutral-900 flex flex-col items-center">
          <div className={`flex items-center mb-4 w-full ${isCollapsed ? 'justify-center' : 'space-x-3'}`}>
            <div className="w-9 h-9 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-500 flex items-center justify-center font-bold text-sm flex-shrink-0">
      ...
      {/* Floating White Main Section Container - 6px margin top, bottom, right; 2px left */}
      <div className="flex-1 flex flex-col min-w-0 bg-white border border-neutral-200 rounded-md my-[6px] mr-[6px] ml-[2px] overflow-hidden">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative hidden md:block">
              ...
              <input
                ...
                className="w-56 pl-8 pr-3 py-1.5 bg-neutral-50 border border-neutral-200 rounded-md text-sm placeholder-neutral-400 focus:outline-none focus:bg-white focus:border-amber-500 transition-colors"
              />
            </div>
        ...
        {/* Content Body - uniform p-6 padding to match top/bottom, no max-width limits */}
