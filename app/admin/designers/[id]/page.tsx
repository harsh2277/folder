  ...
  if (!designer) {
    return (
      <div className="text-center py-12 text-sm">
        <h2 className="text-lg font-semibold text-neutral-900">Designer profile not found.</h2>
    ...
    <div className="space-y-6 text-sm">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center space-x-3.5">
          ...
          <div>
            <h2 className="text-xl font-semibold text-neutral-900 font-sans">{designer.name}</h2>
      ...
      <div className="bg-white border border-neutral-200 rounded-md p-5 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <span className="text-neutral-800 font-semibold">{designer.email}</span>
          </div>
          <div>
            <span className="text-neutral-400 font-semibold block mb-0.5">Phone Number</span>
            <span className="text-neutral-800 font-semibold font-sans">{designer.mobile_number || 'Not Provided'}</span>
          </div>
          <div>
            <span className="text-neutral-400 font-semibold block mb-0.5">Joined Workspace</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white border border-neutral-200 rounded-md p-5 flex items-center justify-between shadow-sm">
          <div className="space-y-1">
            <span className="text-sm font-semibold text-neutral-400 block">Designs Completed</span>
      ...
      <div className="space-y-4">
        <div>
          <h3 className="text-lg font-semibold text-neutral-900 font-sans">Active Workspaces</h3>
