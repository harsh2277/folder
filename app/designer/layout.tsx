      ...
      <aside className={`bg-neutral-950 flex flex-col justify-between text-neutral-300 transition-all duration-300 ${isCollapsed ? 'w-16' : 'w-64'}`}>
        <div className="overflow-y-auto flex-1">
          ...
          <div className={`p-4 flex items-center bg-neutral-950 ${isCollapsed ? 'justify-center' : 'space-x-3'}`}>
            <div className="w-8 h-8 rounded-md bg-emerald-600 flex items-center justify-center text-white flex-shrink-0">
            ...
            {!isCollapsed && (
              <div>
                ...
                <span className="text-xs text-neutral-500 font-bold">Designer Workspace</span>
              </div>
            )}
          </div>
        ...
        <div className="p-4 bg-neutral-900/10 border-t border-neutral-900 flex flex-col items-center">
          <div className={`flex items-center mb-4 w-full ${isCollapsed ? 'justify-center' : 'space-x-3'}`}>
            <div className="w-9 h-9 rounded-full bg-emerald-600/10 border border-emerald-600/20 text-emerald-500 flex items-center justify-center font-bold text-sm flex-shrink-0">
              {profile?.name ? profile.name.substring(0, 2).toUpperCase() : 'DE'}
            </div>
            {!isCollapsed && (
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative hidden md:block">
              ...
              <input
                ...
                className="w-56 pl-8 pr-3 py-1.5 bg-neutral-50 border border-neutral-200 rounded-md text-sm placeholder-neutral-400 focus:outline-none focus:bg-white focus:border-emerald-500 transition-colors"
              />
            </div>
            ...
            <div className="relative p-1.5 hover:bg-neutral-100 rounded-md cursor-pointer transition-colors">
              ...
              <span className="absolute top-1 right-1 w-2.5 h-2.5 rounded-full bg-emerald-600"></span>
            </div>
